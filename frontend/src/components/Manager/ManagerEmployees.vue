<template>
  <div class="container">
    <div class="my-4">
      ...
      <a class="btn btn-outline-dark mr-1" href="/manager/suppliers">Suppliers</a>
      <a class="btn btn-outline-dark mr-1" href="/manager/deliveries">Deliveries</a>
      <a class="btn btn-outline-dark mr-1 active" href="/manager/employees">Employees</a>
      <a class="btn btn-outline-dark mr-1" href="/manager/inbox">Inbox</a>
    </div>
    <h1>Manager Page - Employees</h1>
...
export default {
  ...
  methods: {
    ...
    async getAssignedEvents(id) {
      try {
        const response = await axios.get(`http://localhost:3000/manager/employees/${id}`);
    ...
    async addEmployee() {
      try {
        await axios.post("http://localhost:3000/manager/employees", {
          username: "",
